  ...
  class CyberSeedsSnapshot extends HTMLElement {
    ...
    render(){
      ...
      const css = `
        ...
        .btn:focus-visible,
        #csPanel label:focus-within{
          outline:3px solid #1a6a5d;
          outline-offset:2px;
        }
        ...
        #csPanel input[type="radio"]:focus-visible{
          outline:2px solid #1a6a5d;
          outline-offset:2px;
        }
      ...
      this.shadowRoot.innerHTML = `
        ...
        <div class="wrap" aria-hidden="true">
          ...
          <section class="modal" role="dialog" aria-modal="true" aria-labelledby="csTitle" aria-describedby="csHint">
            ...
            <header class="top">
              ...
              <button id="csClose" class="btn" type="button" aria-label="Close the household snapshot dialog">Close</button>
            ...
            <footer class="footer">
              ...
              <div>
                <button id="csBack" class="btn" type="button" aria-label="Go to the previous question">Back</button>
                <button id="csNext" class="btn primary" type="button" aria-label="Go to the next step in the household snapshot">Begin</button>
              </div>
    ...
    close(){
      ...
      if (IS_SNAPSHOT_PAGE && this._completed){
...
finish(){
  ...
  // Keep a stable launcher hook for existing and future UI entry points.
  window.ensureSnapshotElement = ensureSnapshotElement;
